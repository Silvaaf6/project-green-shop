<header class="top-header">
    <nav class="navbar navbar-expand align-items-center gap-4">
        ...
        <ul class="navbar-nav gap-1 nav-right-links align-items-center">
            <li class="nav-item d-lg-none mobile-search-btn" style="display: none">
                    ...
                    <div class="border rounded-4 overflow-hidden">
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/01.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/02.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/03.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/04.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/05.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/06.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0 border-bottom">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/07.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/08.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/09.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                        ...
                        <div class="row row-cols-3 g-0">
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/10.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col border-end">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/11.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                            ...
                            <div class="col">
                                <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                    <div class="app-icon">
                                        <img src="{{ asset('backend/assets/images/apps/12.png') }}" width="36"
                                            alt="">
                                    </div>
                                    <div class="app-name">
                    ...
                    <div class="notify-list">
                        ...
                        <div>
                            <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="">
                                        <img src="{{ asset('backend/assets/images/apps/13.png') }}"
                        ...
                        <div>
                            <a class="dropdown-item border-bottom py-2" href="javascript:;">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="">
                                        <img src="{{ asset('backend/assets/images/apps/14.png') }}"
                                            class="rounded-circle" width="45" height="45" alt="">
                                    </div>
                                    <div class="">
