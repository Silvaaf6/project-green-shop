            ...
            <form class="row g-3" method="POST" action="{{ route('kategori.store') }}">
                ...
                <div class="col-md-4x">
                    ...
                    <div class="position-relative input-icon">
                        <input type="text" name="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" id="input13" value="{{ old('nama_kategori') }}" placeholder="Nama Kategori" required>
